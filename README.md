...
- **Scroll-reveal animations** — smooth fade/stagger effects powered by IntersectionObserver
- **Sections included:**
  - Hero introduction
  - About
  - How I Work (process breakdown)
  - Skills (with proficiency/learning status)
  - Services (freelance offerings)
  - Right Now (current learning progress)
...
- Google Fonts — Archivo, Inter, IBM Plex Mono
...
- **GitHub:** [@zunaidahmad1528](https://github.com/zunaidahmad1528-netizen)
